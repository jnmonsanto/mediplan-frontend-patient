...
export const mockPlans: Plan[] = [
  {
    ...
    exercises: [
      { exerciseId: "ex-1-1", sets: 2, repetitions: 0, duration: 30, exercise: mockExercises[0] },
      { exerciseId: "ex-1-2", sets: 0, repetitions: 15, duration: 30, exercise: mockExercises[1] },
      { exerciseId: "ex-1-3", sets: 0, repetitions: 30, duration: 45, exercise: mockExercises[2] },
      { exerciseId: "ex-1-4", sets: 2, repetitions: 0, duration: 30, exercise: mockExercises[3] },
    ],
    score: 85,
    rating: 4.5,
  ...
  },
  {
    ...
    exercises: [
      { exerciseId: "ex-2-1", sets: 3, repetitions: 12, duration: 45, exercise: mockExercises[4] },
      { exerciseId: "ex-2-2", sets: 3, repetitions: 10, duration: 45, exercise: mockExercises[5] },
      { exerciseId: "ex-2-3", sets: 3, repetitions: 12, duration: 40, exercise: mockExercises[6] },
      { exerciseId: "ex-2-4", sets: 3, repetitions: 0, duration: 60, exercise: mockExercises[7] },
    ],
    score: 90,
    rating: 4.7,
  ...
  },
  {
    ...
    exercises: [
      { exerciseId: "ex-3-1", sets: 3, repetitions: 15, duration: 45, exercise: mockExercises[8] },
      { exerciseId: "ex-3-2", sets: 2, repetitions: 12, duration: 40, exercise: mockExercises[9] },
      { exerciseId: "ex-3-3", sets: 3, repetitions: 15, duration: 45, exercise: mockExercises[10] },
      { exerciseId: "ex-3-4", sets: 3, repetitions: 20, duration: 30, exercise: mockExercises[11] },
    ],
    score: 88,
    rating: 4.6,
  ...
  },
  {
    ...
    exercises: [
      { exerciseId: "ex-4-1", sets: 0, repetitions: 0, duration: 60, exercise: mockExercises[12] },
      { exerciseId: "ex-4-2", sets: 0, repetitions: 10, duration: 45, exercise: mockExercises[13] },
      { exerciseId: "ex-4-3", sets: 0, repetitions: 0, duration: 60, exercise: mockExercises[14] },
      { exerciseId: "ex-4-4", sets: 0, repetitions: 0, duration: 45, exercise: mockExercises[15] },
    ],
    score: 82,
    rating: 4.4,
  ...
  },
  {
    ...
    exercises: [
      { exerciseId: "ex-5-1", sets: 3, repetitions: 12, duration: 40, exercise: mockExercises[16] },
      { exerciseId: "ex-5-2", sets: 3, repetitions: 20, duration: 45, exercise: mockExercises[17] },
      { exerciseId: "ex-5-3", sets: 3, repetitions: 10, duration: 40, exercise: mockExercises[18] },
      { exerciseId: "ex-5-4", sets: 3, repetitions: 20, duration: 45, exercise: mockExercises[19] },
    ],
    score: 92,
    rating: 4.8,
